...
// PXREAService.grpc.pb.cc 파일 상단 수정
#include "PXREAService.pb.h"       // 1순위: 클래스 정의를 먼저 로드
#include "PXREAService.grpc.pb.h"  // 2순위: 그 정의를 사용하는 서비스 로드
#include <grpcpp/impl/codegen/config.h> // 3순위: gRPC 설정 로드
