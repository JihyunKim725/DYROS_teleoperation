...
#include "xr_msgs/msg/detail/custom__type_support.h"
...
static const _Custom_type_support_symbol_names_t _Custom_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xr_msgs, msg, Custom)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xr_msgs, msg, Custom)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xr_msgs, msg, Custom)() {
  return &::xr_msgs::msg::rosidl_typesupport_c::Custom_message_type_support_handle;
}
